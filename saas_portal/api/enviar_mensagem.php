...
// Verificar permissão para enviar mensagem (validando empresa_id)
...
try {
    $stmt = $pdo->prepare("INSERT INTO saas_mensagens (chamado_id, usuario_id, mensagem, imagem) VALUES (:cid, :uid, :msg, :img)");

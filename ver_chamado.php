...
// Buscar chamado
$sql = "SELECT c.*, u.nome as criador_nome FROM chamados c JOIN usuarios u ON c.usuario_id = u.id WHERE c.id = :id";
...
<div class="app-container">
    ...
    <div class="main-content">
        ...
        <?php if ($tipo === 'master' && !in_array($chamado['status'], ['resolvido', 'fechado'])): ?>
            ...
            <?php 
                $prods_disponiveis = $pdo->query("SELECT * FROM produtos WHERE quantidade > 0 ORDER BY nome")->fetchAll(PDO::FETCH_ASSOC);
            ?>
